...
public class Service {
	 ...
	 * 
	 */
	public static ArrayList<UsersDTO.Get> getUsersAll() throws NotExistException {
	...
	public static ArrayList<ProductDTO.Get> getProductByCategory(String category) throws NotExistException {
		...
		//	주문 조회
		public static ArrayList<OrdersDTO.Get> getOrdersAll() throws SQLException, NotExistException {
			ArrayList<OrdersDTO.Get> all = ordersDAO.getOrdersAll();
			if(all == null) {
		 ...
		 * 
		 */
		public static boolean updateOrders(Long idx, Long productIdx) {
